...
from tulip.handlers.admin import demote, pin, promote, unpin
...
if __name__ == "__main__":
    ...
    application.add_handler(CommandHandler("pin", pin), group=2)
    application.add_handler(CommandHandler("unpin", unpin), group=2)
